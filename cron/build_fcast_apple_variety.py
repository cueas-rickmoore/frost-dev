...
if debug: print target_year, season_start, season_end
...
if debug:
    print 'frost_filepath', frost_filepath
    print 'chill_filepath', chill_filepath
    print 'temps_filepath', temps_filepath
    print 'tool_filepath', tool_filepath
...
fcast_start_date = temps_dates.get('fcast_start_date', None)
if fcast_start_date is not None:
