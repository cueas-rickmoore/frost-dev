...
basemap_datadir = '/usr/local/Cellar/python/2.7.6/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/mpl_toolkits/basemap/data'
...
class Basemap(object):
    ...
    def __init__(self, llcrnrlon=None, llcrnrlat=None,
                       ...
                       epsg=None,
                       ax=None):
        print 'in Basemap = llcrnr', llcrnrlon, llcrnrlat
        print 'in Basemap = urcrnr', urcrnrlon, urcrnrlat
        ...
        print 'in Basemap - projection', projection
        ...
        print 'in Basemap - projparams', projparams
        print 'in Basemap = llcrnr', self.llcrnrlon,self.llcrnrlat
        print 'in Basemap = urcrnr', self.urcrnrlon,self.urcrnrlat
        # initialize proj4
        proj = Proj(projparams, self.llcrnrlon,self.llcrnrlat,self.urcrnrlon,self.urcrnrlat)
        print 'in Basemap - proj', proj
        ...
        print 'in Basemap - projected x,y ', proj.xmin, proj.xmax, proj.ymin, proj.ymax
        self.xmin = proj.xmin
        self.xmax = proj.xmax
        self.ymin = proj.ymin
        self.ymax = proj.ymax
        ...
        print 'in Basemap - _boundarypolyll'
        ...
        if self.resolution is not None:
            print 'in Basemap - coastpolygons _readboundarydata as polygons'
            ...
            print 'in Basemap - coastpolygons _readboundarydata as line segments'
    ...
    def _getmapboundary(self):
        ...
        if self.projection in ['ortho','geos','nsper']:
            ...
            print 'in _getmapboundary rectangular projection'
            print 'x', self.xmin, self.xmax, 'y', self.ymin, self.ymax
            nx = 100*nx; ny = 100*ny
            ...
            print 'in _getmapboundary b', b
            boundaryxy = _geoslib.Polygon(b)
            print 'in _getmapboundary boundaryxy', boundaryxy
        if self.projection in _cylproj:
